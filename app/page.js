    ...
    <>
      <div className="flex items-center justify-center text-white">
        <div className="h-[44vh] flex flex-col justify-center items-center">
          <div className="flex md:text-5xl font-bold mb-3 gap-4 text-3xl">Welcome to FundOra <span><Image className="md:h-15 h-7 rounded-4xl" src="/Money Bag.gif" width={52} height={32} alt="Funding App Logo" /></span></div>
