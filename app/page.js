    ...
    <>
      <div className="flex items-center justify-center text-white">
        <div className="h-[44vh] flex flex-col justify-center items-center">
          <div className="flex md:text-5xl font-bold mb-3 gap-4 text-3xl">Welcome to FundOra <span><img className="md:h-15 h-7 rounded-4xl" src="/Money Bag.gif" alt="Funding App Logo" /></span></div>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex justify-center items-center gap-10 mt-10 flex-wrap">
          <div>
            <div className="text-1xl text-white mt-4 w-80 text-sm flex items-center flex-col"><img className="h-20 m-2" src="/developer.gif" alt="" srcSet="" /><h1 className="text-1xl">Fund Yourself</h1>Your fans are available for you to help you</div>
          </div>
          <div>
            <div className="text-1xl text-white mt-4 w-80 text-sm flex items-center flex-col"><img className="h-20 m-2" src="/coin.gif" alt="" srcSet="" /><h1 className="text-1xl">Fund Yourself</h1>Your fans are available for you to help you</div>
          </div>
          <div>
            <div className="text-1xl text-white mt-4 w-80 text-sm flex items-center flex-col"><img className="h-20 m-2 rounded-4xl" src="/funds.gif" alt="" srcSet="" /><h1 className="text-1xl">Fans wants to help</h1>Your fans are available for you to help you</div>
          </div>
        </div>
      </div>
    </>
